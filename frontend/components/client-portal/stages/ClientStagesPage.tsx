...
import { stageStatusLabel, statusVariant } from "@/components/client-portal/ui/client-portal-status";

const filters: { label: string; value: "all" | ClientStageStatus }[] = [{ label: "Todas", value: "all" }, { label: "Em andamento", value: "in_progress" }, { label: "Aguardando voce", value: "waiting_client" }, { label: "Concluidas", value: "completed" }];
